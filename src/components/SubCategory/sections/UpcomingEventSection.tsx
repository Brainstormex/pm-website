                ...
                <SwiperSlide key={index} className="!w-auto">
                  ...
                  >
                    <div className="flex items-start gap-4 w-[350px] lg:w-[400px] h-full">
                      <div className="relative w-[150px] lg:w-[180px] h-[100px] rounded-2xl overflow-hidden flex-shrink-0 bg-black/30">
                        <Image
                          src={event.image}
                          alt={event.title}
                      ...
                      <div className="flex-1 pt-1 h-full justify-between flex flex-col">
                        <div>
                          <div className="text-inkBlack font-inter text-xs font-bold mt-1">
                            {event.date}
                          </div>
                          <h3 className="text-xl font-medium line-clamp-1 overflow-hidden w-full group-hover:text-orange">
                            {event.title}
                          </h3>
                        </div>
                        <div className="flex items-center gap-2 text-sm text-gray-500 font-inter font-normal mb-1">
